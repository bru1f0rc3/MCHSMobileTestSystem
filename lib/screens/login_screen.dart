...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget _buildBackgroundCircles(bool isDark) {
    final color1 = isDark ? const Color(0xFFE63946) : const Color(0xFFE63946); // Красный МЧС
    final color2 = isDark ? const Color(0xFF415A77) : const Color(0xFF457B9D); // Синий
    final color3 = isDark ? const Color(0xFF1D3557) : const Color(0xFF1D3557); // Темно-синий
